...
| ---------- | ----------------------- | ---------------------- |
| 无工具     | `none`                  | 选择/编辑模式          |
| 水平线段   | `horizontal-line`       | 绘制水平线段标注       |
| 垂直线段   | `vertical-line`         | 绘制垂直线段标注       |
...
const isCreating = useAppSelector(selectIsCreatingAnnotation);
```
...
| `isFileOpened`      | `boolean`           | 文件是否已打开         |
| `hasUnsavedChanges` | `boolean`           | 是否有未保存的更改     |
| `isLoading`         | `boolean`           | 异步操作进行中         |
| `error`             | `FileError \| null` | 错误信息               |

**FileError 结构**：

| 字段      | 类型            | 说明     |
| --------- | --------------- | -------- |
| `code`    | `FileErrorCode` | 错误码   |
| `message` | `string`        | 错误消息 |
...
| `setError`        | `FileError \| null`                      | 设置错误信息            |
| `clearError`      | 无                                       | 清除错误信息            |
...
| Thunk           | Payload                               | 说明                 |
| --------------- | ------------------------------------- | -------------------- |
| `createNewFile` | `directory: string, fileName: string` | 新建空白标记文件     |
| `openFile`      | `filePath: string`                    | 打开已存在的标记文件 |
| `saveFile`      | 无                                    | 保存当前文件（覆盖） |
| `saveFileAs`    | `directory: string, fileName: string` | 另存为新文件         |
...
| `selectIsLoading`         | `boolean`           | 是否正在加载       |
| `selectFileError`         | `FileError \| null` | 获取错误信息       |
...
| `selectFileDisplayName`         | -    | `string`         | 显示名称（有更改时带 \* 标记）       |
| `selectFileErrorMessage`        | -    | `string \| null` | 获取错误消息文本                     |
