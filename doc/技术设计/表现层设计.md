...
| `showAuxiliaryLines` | `boolean` | 是 | - | Redux：`selectShowAuxiliaryLines` | 辅助线开关当前状态，用于 toggle 按钮的激活显示 |
...
| `setRotation(imageId, angle + 90)` | 点击「顺时针旋转」 | [画布模块](./业务逻辑层.md#画布模块-canvas-module) |
| `setRotation(imageId, 0)` | 点击「重置旋转」 | [画布模块](./业务逻辑层.md#画布模块-canvas-module) |
| `toggleAuxiliaryLines()` | 点击「辅助线开关」 | [画布模块](./业务逻辑层.md#画布模块-canvas-module) |
...
sequenceDiagram
    ...
    Toolbar->>Redux: dispatch toggleAuxiliaryLines()
    Redux-->>Redux: canvas.showAuxiliaryLines 取反
