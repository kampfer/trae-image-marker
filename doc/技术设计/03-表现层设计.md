...
| 选择器名             | 来源                                                          | 说明                             |
| -------------------- | ------------------------------------------------------------- | -------------------------------- |
| `selectIsFileOpened` | Redux：[文件模块](./04-业务逻辑层.md#文件管理模块-file-slice) | 判断当前是否存在已打开的标注文件 |
...
sequenceDiagram
    ...
    Placeholder->>Redux: dispatch newMarkerFile()
...
| Action 名          | 调用时机             | 业务逻辑层定义                                   |
| ------------------ | -------------------- | ------------------------------------------------ |
| `newMarkerFile()`  | 点击「新建标注文件」 | [文件模块](./业务逻辑层.md#文件模块-file-module) |
| `openMarkerFile()` | 点击「打开标注文件」 | [文件模块](./业务逻辑层.md#文件模块-file-module) |
...
sequenceDiagram
    ...
    Placeholder->>Redux: dispatch openMarkerFile()
