...
**功能**：提供应用的主题配置，确保整个应用使用一致的主题样式。

**结构**：
- 主题配置：颜色方案、字体、交互效果等
- 主题上下文：通过 React Context 提供主题信息给所有子组件

**文件路径**：`src/components/ThemeProvider/ThemeProvider.tsx`

##### 6.1.2.2 StoreProvider 组件

**功能**：提供应用的状态管理，使用 Redux 或其他状态管理库管理全局状态。

**结构**：
- 状态配置：定义 reducer、action 和初始状态
- 状态上下文：通过 React Context 提供状态信息给所有子组件
- 状态管理：处理应用状态的更新和持久化

**文件路径**：`src/components/StoreProvider/StoreProvider.tsx`
...
**结构**：
- 文件菜单：新建、打开、保存、另存为、添加图片、删除图片、导出为PNG
- 编辑菜单：撤销、重做、清除所有标注、删除选中标注
- 标注菜单：水平线段、垂直线段、普通量角器、水平量角器、垂直量角器
- 图片菜单：放大、缩小、适应窗口、实际大小、旋转
- 帮助菜单：开发者工具

**文件路径**：`src/components/MenuBar/MenuBar.tsx`
...
**文件路径**：`src/components/TabsBar/TabsBar.tsx`
...
**文件路径**：`src/components/Canvas/Canvas.tsx`

##### 6.1.2.6 FloatingToolbar 组件
...
**文件路径**：`src/components/Canvas/FloatingToolbar.tsx`

##### 6.1.2.7 AnnotationTools 组件
...
**文件路径**：`src/components/Canvas/AnnotationTools.tsx`

##### 6.1.2.8 ImageTools 组件
...
**文件路径**：`src/components/Canvas/ImageTools.tsx`

##### 6.1.2.9 AuxiliaryTools 组件
...
**文件路径**：`src/components/Canvas/AuxiliaryTools.tsx`

##### 6.1.2.10 ImageContainer 组件
...
**文件路径**：`src/components/Canvas/ImageContainer.tsx`

##### 6.1.2.11 Annotations 组件
...
**文件路径**：`src/components/Canvas/Annotations.tsx`
...
**文件路径**：`src/components/Footer/Footer.tsx`
